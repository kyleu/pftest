...
This file provides guidance for AI agents and humans working with the Test Project codebase.
...
**Test Project**
 ...
 This app is pretty much totally generated via Project Forge
...
- `/app/lib/`: Mostly logic provided by github.com/kyleu/pftest
...
The project definition lives in `.projectforge/project.json`, which represents the [github.com/kyleu/pftest(httpsgithub.com/kyleu/pftestv) configuration.
