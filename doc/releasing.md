...
Your releases are available at https://github.com/kyleu/pftest/releases
...
Multiple Docker images will be created. The main image is `ghcr.io/kyleu/pftest/x.x.x`, and a debug image is provided at `ghcr.io/kyleu/pftest/x.x.x-debug` that includes `delve` for debugging
...
The source code will be bundled in the release, available as `pftest_x.x.x_source.zip`
