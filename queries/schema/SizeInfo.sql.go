...
-- `)
//line queries/schema/SizeInfo.sql:118
	case "sqlserver":
//line queries/schema/SizeInfo.sql:118
		qw422016.N().S(`
with sizeinfo as (
...
order by "total" desc;
-- `)
//line queries/schema/SizeInfo.sql:168
	default:
//line queries/schema/SizeInfo.sql:168
		qw422016.N().S(`
select 'unhandled database type [`)
//line queries/schema/SizeInfo.sql:169
		qw422016.E().S(dbType)
//line queries/schema/SizeInfo.sql:169
		qw422016.N().S(`]';
-- `)
//line queries/schema/SizeInfo.sql:170
	}
//line queries/schema/SizeInfo.sql:170
	qw422016.N().S(`
-- `)
//line queries/schema/SizeInfo.sql:171
}
