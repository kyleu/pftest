...
order by "table_name";
-- `)
//line queries/schema/SizeInfo.sql:64
	case "sqlserver":
//line queries/schema/SizeInfo.sql:64
		qw422016.N().S(`
with sizeinfo as (
...
order by "total" desc;
-- `)
//line queries/schema/SizeInfo.sql:114
	default:
//line queries/schema/SizeInfo.sql:114
		qw422016.N().S(`
select 'unhandled database type [`)
//line queries/schema/SizeInfo.sql:115
		qw422016.E().S(dbType)
//line queries/schema/SizeInfo.sql:115
		qw422016.N().S(`]';
-- `)
//line queries/schema/SizeInfo.sql:116
	}
//line queries/schema/SizeInfo.sql:116
	qw422016.N().S(`
-- `)
//line queries/schema/SizeInfo.sql:117
}
