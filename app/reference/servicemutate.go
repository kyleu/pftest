...
func (s *Service) Create(ctx context.Context, tx *sqlx.Tx, models ...*Reference) error {
	if len(models) == 0 {
		return nil
	}
...
func (s *Service) Update(ctx context.Context, tx *sqlx.Tx, model *Reference) error {
...
func (s *Service) Save(ctx context.Context, tx *sqlx.Tx, models ...*Reference) error {
	if len(models) == 0 {
		return nil
	}
	for _, model := range models {
