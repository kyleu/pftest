...
import (
	...
	"github.com/kyleu/pftest/views/vtask"
)
...
func TaskStart(w http.ResponseWriter, r *http.Request) {
	controller.Act("task.start", w, r, func(as *app.State, ps *cutil.PageState) (string, error) {
		...
		id, err := as.Services.Socket.Upgrade(ps.Context, w, r, nil, ch, ps.User, ps.Profile, ps.Accounts, websocket.EchoHandler, ps.Logger)
		if err != nil {
