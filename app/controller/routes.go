...
func AppRoutes() fasthttp.RequestHandler {
	...
	r.GET("/relation", RelationList)
	r.GET("/relation/random", RelationCreateFormRandom)
	r.GET("/relation/new", RelationCreateForm)
	r.POST("/relation/new", RelationCreate)
	r.GET("/relation/{id}", RelationDetail)
	r.GET("/relation/{id}/edit", RelationEditForm)
	r.POST("/relation/{id}/edit", RelationEdit)
	r.GET("/relation/{id}/delete", RelationDelete)
