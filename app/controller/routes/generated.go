...
func generatedRoutes(r *router.Router) {
	...
	r.GET("/hist", controller.HistList)
	r.GET("/hist/random", controller.HistCreateFormRandom)
	r.GET("/hist/new", controller.HistCreateForm)
	r.POST("/hist/new", controller.HistCreate)
	r.GET("/hist/{id}", controller.HistDetail)
	r.GET("/hist/{id}/edit", controller.HistEditForm)
	r.POST("/hist/{id}/edit", controller.HistEdit)
	r.GET("/hist/{id}/delete", controller.HistDelete)
	r.GET("/hist/{id}/history/{historyID}", controller.HistHistory)
