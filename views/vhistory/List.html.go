...
//line views/vhistory/List.html:2
package vhistory
...
//line views/vhistory/List.html:11
import (
	qtio422016 "io"
...
type List struct {
	layout.Basic
	Models history.Histories
	Params filter.ParamSet
}

//line views/vhistory/List.html:17
func (p *List) StreamBody(qw422016 *qt422016.Writer, as *app.State, ps *cutil.PageState) {
//line views/vhistory/List.html:17
	qw422016.N().S(`
  <div class="card">
    <div class="right"><a href="/history/new"><button>New</button></a></div>
    <h3>`)
...
`)
//line views/vhistory/List.html:23
	} else {
//line views/vhistory/List.html:23
		qw422016.N().S(`    <div class="overflow clear">
      `)
//line views/vhistory/List.html:25
		StreamTable(qw422016, p.Models, p.Params, as, ps)
//line views/vhistory/List.html:25
		qw422016.N().S(`
    </div>
`)
//line views/vhistory/List.html:27
	}
//line views/vhistory/List.html:27
	qw422016.N().S(`  </div>
`)
//line views/vhistory/List.html:29
}
