...
//line views/vtimestamp/Table.html:10
func StreamTableRow(qw422016 *qt422016.Writer, model *timestamp.Timestamp, ps *cutil.PageState, paths ...string) {
//line views/vtimestamp/Table.html:10
	qw422016.N().S(`
  <tr>
    <td><a href="`)
...
//line views/vtimestamp/Table.html:12
	qw422016.N().S(`</a></td>
    <td>`)
//line views/vtimestamp/Table.html:13
	view.StreamTimestamp(qw422016, &model.Created)
//line views/vtimestamp/Table.html:13
	qw422016.N().S(`</td>
    <td>`)
//line views/vtimestamp/Table.html:14
	view.StreamTimestamp(qw422016, model.Updated)
//line views/vtimestamp/Table.html:14
	qw422016.N().S(`</td>
    <td>`)
//line views/vtimestamp/Table.html:15
...
//line views/vtimestamp/Table.html:17
func WriteTableRow(qq422016 qtio422016.Writer, model *timestamp.Timestamp, ps *cutil.PageState, paths ...string) {
//line views/vtimestamp/Table.html:17
...
//line views/vtimestamp/Table.html:17
func TableRow(model *timestamp.Timestamp, ps *cutil.PageState, paths ...string) string {
//line views/vtimestamp/Table.html:17
...
//line views/vtimestamp/Table.html:19
	qw422016.N().S(`
`)
//line views/vtimestamp/Table.html:20
...
//line views/vtimestamp/Table.html:28
	qw422016.N().S(`
      ...
      <tbody>
`)
//line views/vtimestamp/Table.html:32
...
//line views/vtimestamp/Table.html:38
		qw422016.N().S(`  <hr />
  `)
//line views/vtimestamp/Table.html:40
		components.StreamPagination(qw422016, len(models)+prms.Offset, prms, ps.URI)
//line views/vtimestamp/Table.html:40
		qw422016.N().S(`
  <div class="clear"></div>
`)
//line views/vtimestamp/Table.html:42
	}
//line views/vtimestamp/Table.html:43
}
