...
//line views/vbasic/Edit.html:10
import (
	qtio422016 "io"
...
//line views/vbasic/Edit.html:16
...
//line views/vbasic/Edit.html:18
	if p.IsNew {
//line views/vbasic/Edit.html:18
		qw422016.N().S(`    <div class="right"><a href="/basic/random"><button>Random</button></a></div>
    <h3>`)
//line views/vbasic/Edit.html:20
		components.StreamSVGRefIcon(qw422016, `star`, ps)
//line views/vbasic/Edit.html:20
		qw422016.N().S(` New Basic</h3>
    <form action="/basic/new" class="mt" method="post">
`)
...
//line views/vbasic/Edit.html:23
		qw422016.N().S(`/delete" onclick="return confirm('Are you sure you wish to delete basic [`)
//line views/vbasic/Edit.html:23
