...
//line views/vbasic/List.html:12
import (
	qtio422016 "io"
...
//line views/vbasic/List.html:19
...
//line views/vbasic/List.html:23
	if len(p.Models) > 0 {
//line views/vbasic/List.html:23
		qw422016.N().S(`<a href="/basic/_random"><button>Random</button></a>`)
//line views/vbasic/List.html:23
	}
//line views/vbasic/List.html:23
	qw422016.N().S(`      <a href="/basic/_new"><button>New</button></a>
    </div>
    <h3>`)
...
//line views/vbasic/List.html:34
      ...
      `)
//line views/vbasic/List.html:36
		StreamTable(qw422016, p.Models, p.Params, as, ps)
//line views/vbasic/List.html:36
		qw422016.N().S(`
    </div>
`)
//line views/vbasic/List.html:38
	}
//line views/vbasic/List.html:38
	qw422016.N().S(`  </div>
`)
//line views/vbasic/List.html:40
}
