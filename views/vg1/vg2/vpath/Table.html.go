...
//line views/vg1/vg2/vpath/Table.html:10
func StreamTableRow(qw422016 *qt422016.Writer, model *path.Path, ps *cutil.PageState, paths ...string) {
//line views/vg1/vg2/vpath/Table.html:10
	qw422016.N().S(`
  <tr>
    <td><a href="`)
...
//line views/vg1/vg2/vpath/Table.html:12
	qw422016.N().S(`</a></td>
    <td><a href="`)
//line views/vg1/vg2/vpath/Table.html:13
	qw422016.E().S(model.WebPath(paths...))
//line views/vg1/vg2/vpath/Table.html:13
	qw422016.N().S(`"><strong>`)
//line views/vg1/vg2/vpath/Table.html:13
...
//line views/vg1/vg2/vpath/Table.html:13
    ...
    <td><strong>`)
//line views/vg1/vg2/vpath/Table.html:14
	qw422016.E().S(model.Status)
//line views/vg1/vg2/vpath/Table.html:14
	qw422016.N().S(`</strong></td>
    <td>`)
//line views/vg1/vg2/vpath/Table.html:15
...
//line views/vg1/vg2/vpath/Table.html:17
func WriteTableRow(qq422016 qtio422016.Writer, model *path.Path, ps *cutil.PageState, paths ...string) {
//line views/vg1/vg2/vpath/Table.html:17
...
//line views/vg1/vg2/vpath/Table.html:17
func TableRow(model *path.Path, ps *cutil.PageState, paths ...string) string {
//line views/vg1/vg2/vpath/Table.html:17
...
//line views/vg1/vg2/vpath/Table.html:28
	qw422016.N().S(`
      ...
      <tbody>
`)
//line views/vg1/vg2/vpath/Table.html:32
...
//line views/vg1/vg2/vpath/Table.html:40
  ...
  <div class="clear"></div>
`)
//line views/vg1/vg2/vpath/Table.html:42
	}
//line views/vg1/vg2/vpath/Table.html:43
}
