...
//line views/vsoftdel/Edit.html:1
package vsoftdel
...
//line views/vsoftdel/Edit.html:24
		qw422016.N().S(`/delete" data-message="Are you sure you wish to delete softdel [`)
//line views/vsoftdel/Edit.html:24
...
//line views/vsoftdel/Edit.html:27
	qw422016.E().S(util.Choose(p.IsNew, softdel.Route(p.Paths...)+`/_new`, p.Model.WebPath(p.Paths...)+`/edit`))
//line views/vsoftdel/Edit.html:27
