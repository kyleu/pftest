...
//line views/vaudited/Edit.html:2
package vaudited
...
//line views/vaudited/Edit.html:10
import (
	qtio422016 "io"
...
//line views/vaudited/Edit.html:16
...
//line views/vaudited/Edit.html:18
	if p.IsNew {
//line views/vaudited/Edit.html:18
		qw422016.N().S(`    <div class="right"><a href="/audited/random"><button>Random</button></a></div>
    <h3>`)
//line views/vaudited/Edit.html:20
		components.StreamSVGRefIcon(qw422016, `star`, ps)
//line views/vaudited/Edit.html:20
		qw422016.N().S(` New Audited</h3>
    <form action="/audited/new" class="mt" method="post">
`)
...
//line views/vaudited/Edit.html:23
		qw422016.N().S(`/delete" onclick="return confirm('Are you sure you wish to delete audited [`)
//line views/vaudited/Edit.html:23
...
//line views/vaudited/Edit.html:26
	qw422016.N().S(`      <table class="mt expanded">
        <tbody>
          `)
//line views/vaudited/Edit.html:29
	if p.IsNew {
//line views/vaudited/Edit.html:29
...
`)
//line views/vaudited/Edit.html:36
}
