...
##
## Outputs:
##   - build/dist/pftest_<version>_ios_framework.zip
##   - build/dist/pftest_<version>_ios_app.zip
...
GOARCH=arm64 time gomobile bind -o build/dist/mobile_ios_arm64/pftestServer.xcframework -target=ios github.com/kyleu/pftest/app/cmd
...
cd "$dir/../.."
echo "Output written to ./build/dist/pftest_${TGT}_ios_framework.zip and ./build/dist/pftest_${TGT}_ios_app.zip"
