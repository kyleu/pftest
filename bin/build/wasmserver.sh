...
echo "building Test Project WASM server library..."
GOOS=js GOARCH=wasm go build -o ./build/wasm/pftest.wasm .
echo "Output written to ./build/wasm (pftest.wasm and assets)"
