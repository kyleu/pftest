...
##
## Outputs:
##   - build/dist/pftest_<version>_android_aar.zip
##   - build/dist/pftest_<version>_android_apk.zip
...
echo "Output written to [./build/dist/pftest_${TGT}_android_aar.zip] and [./build/dist/pftest_${TGT}_android_apk.zip]"
